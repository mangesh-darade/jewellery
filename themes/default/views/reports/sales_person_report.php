    ...
    $(document).ready(function () {
        ...
        var oTable = $('#SlRData').dataTable({
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                // Apply values with formatting
                nCells[1].innerHTML = '<div style="text-align:right;">' + formatMoney(tot_items) + '</div>';
                nCells[2].innerHTML = '<div style="text-align:center;">' + formatQuantity(tot_sales) + '</div>';
                nCells[3].innerHTML = '<div style="text-align:center;">' + formatQuantity(tot_amt) + '</div>';
                nCells[4].innerHTML = '<div style="text-align:center;">' + currencyFormat(tot_discount) + '</div>';
                nCells[5].innerHTML = '<div style="text-align:center;">' + currencyFormat(tot_tax) + '</div>';
            }
        });
    });
</script>
