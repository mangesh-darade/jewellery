...
<script>
    $(document).ready(function () {
        ...
        var oTable = $('#PrRData').dataTable({
            ...
            "aoColumns": [{"mRender": fsd} , null, null, null, null,null, null, null, {"mRender": formatQuantity}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, null, {"mRender": currencyFormat}, {"mRender": currencyFormat}],
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
    var purcost = 0, proprice = 0, sprice = 0, gamt = 0, grpft = 0, ntpft = 0, ppft = 0, sdis = 0, totalQty = 0;

    for (var i = 0; i < aaData.length; i++) {
        if (aaData[aiDisplay[i]][8] != null && aaData[aiDisplay[i]][8] !== '') {
            totalQty += parseFloat(aaData[aiDisplay[i]][8]);
        }
    ...
    nCells[8].innerHTML = '<div class="text-center">' + formatQuantity(totalQty) + '</div>'; // column 8 (quantity)
