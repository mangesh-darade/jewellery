                ...
                <div class="well well-sm no-print">
                    ...
                    <div class="controls table-controls">
                        <table id="bcTable"
                            ...
                            <thead>
                                <tr>
                                    <th class="col-xs-5"><?= lang("product_name") . " (" . $this->lang->line("product_code") . ")"; ?></th>
    ...
    function loadItems() {
        ...
        if (localStorage.getItem('bcitems')) {
            ...
            $.each(bcitems, function () {
                ...
                tr_html = '<td><input name="product[]" type="hidden" value="' + row_no + '"><span id="name_' + row_no + '">' + item.name + ' (' + item.code + ')</span></td>';
                tr_html += '<td><label for="' + this.id + '" class="padding05" name="vt_' + item.id + '_' + this.id + '">' + variant_name + '</label></td>';
                tr_html += '<td><input class="form-control quantity text-center" name="quantity[]" type="text" value="' + formatDecimal(item.qty ? item.qty : item.quantity)+ '" data-id="' + row_no + '" data-item="' + item.id + '" id="quantity_' + item.id + '" onClick="this.select();" onchange="qtyset(\''+item.id +'\',\''+item.id+'\')"></td>';
                ...
                tr_html += '<td><input type="text" name="batchno[]" value="'+((item.batchno)? item.batchno: '')+'" id="batchno_'+this.id +'" class="form-control batchno" onchange="batchnoset(\''+this.id +'\',\''+item.id+'\')" style="width: 150px;"></td>';
                tr_html += '<td class="text-center"><i class="fa fa-times tip del" id="' + row_no + '" title="Remove" style="cursor:pointer; width:40px;"></i></td>';
