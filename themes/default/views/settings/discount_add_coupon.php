            ...
            <div class="col-lg-12">
                ...
                <fieldset class="scheduler-border">
                    ...
                    <div class="form-group row "  >
                        ...
                        <div class="col-sm-8">
                            <input type="text" value="<?php echo set_value('max_coupons'); ?>" maxlength="5" name='max_coupons' value="<?= (isset($_POST['max_coupons'])) ? $_POST['max_coupons'] : '' ?>" placeholder="Max Coupons"  autocomplete="off" class="form-control "  id="max_coupons" onkeypress="return event.charCode >= 48 && event.charCode <= 57" onblur="validateMaxCoupons(this)" oninput="if (this.value !== '' && parseInt(this.value) <= 0) this.value='';" />
