    ...
    $('#overselling').change(function() {
        if ($(this).val() == 1) {
            if ($('#accounting_method').select2("val") != 2) {
                bootbox.alert(
                    '<?= lang('overselling_will_only_work_with_AVCO_accounting_method_only') ?>');
                    ...
                    <div class="col-lg-12">
                        <div class="alert alert-info" role="alert">
                            <p>
                                ...
                                <code>0 1 * * * wget -qO- <?= site_url('cron/run'); ?> &gt;/dev/null 2&gt;&amp;1</code>
                                to run at 1:00 AM daily. For local installation, you can run cron job manually at any
                                time.
                                <?php if (!DEMO) { ?>
                                <a class="btn btn-primary btn-xs pull-right" target="_blank"
                                    href="<?= site_url('cron/run'); ?>">Run cron job now</a>
                                <?php } ?>
                            </p>
                        </div>
...
?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="disable_editing"><?= lang("disable_editing"); ?></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" for="restrict_calendar">Calendar</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" for="default_printer">Default Bill Print Option
                                    </label>
                                    <?php
                                    $pl[""] = "";
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("Offline_Warehouse", "Offline_Warehouse"); ?> <img
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("Offline Biller", "Offline Biller"); ?> <img
                                        src="<?= $assets ?>images/new.gif" height="30px" alt="new" />
                                    <?php
                                    $bl[""] = "";
                                    foreach ($billers as $biller) {
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("Barcode Scan Camare", "Barcode Scan Camare"); ?> <img
                                        src="<?= $assets ?>images/new.gif" height="30px" alt="new" />
                                    <?php
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="use_invoice_number_prefix"><?= lang("Use_Invoice_Number_Prefix"); ?></label>
...
<?= form_dropdown('show_total_unit_quantity', $wm, $Settings->show_total_unit_quantity, 'class="form-control" id="show_total_unit_quantity" required="required"'); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="product_external_platform"><?= lang("Delivery Platform"); ?><small>
                                            (Ex.Zomato,Swiggy,etc.)</small></label>
                                    <div class="controls">
                                        <?php
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="product_batch_setting"><?= lang("Batches Setting"); ?> <img
                                            src="<?= $assets ?>images/new.gif" height="25px" alt="new" /> </label>
                                    <div class="controls">
                                        <?php
...
//noedit
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="product_batch_required"><?= lang("Batch Stocks Required"); ?> <img
                                            src="<?= $assets ?>images/new.gif" height="25px" alt="new" /> </label>
                                    <div class="controls">
                                        <?php
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" for="invoice_product_image">Invoice Product
                                        Image</label>
                                    <?php
                                    $invoiceimg[0] = 'Hide';
                                    $invoiceimg[1] = 'Show';
...
?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="tax_classification_view"><?= lang("tax_classification_view"); ?></label>
                                    <div class="controls">
                                        <?php
...
?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="add_tax_in_cart_unit_price"><?= lang("Cart Unit Price (Includeing Tax)"); ?></label>
                                    <div class="controls">
                                        <?php
...
?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" for="add_discount_in_cart_unit_price"
                                        style="margin-top:17px;"><?= lang("Cart Unit Price (Including Discount)"); ?></label>
                                    <div class="controls">
                                        <?php
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" for="invoice_length"
                                        style="margin-top:17px;"><?= lang("Invoice Number Length"); ?></label>
                                    <div class="controls">
                                        <?php
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" for="invoice_format"
                                        style="margin-top:17px;"><?= lang("Invoice Number Format"); ?></label>
                                    <div class="controls">
                                        <?php
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="tax_classification_view"><?= lang("Display_Zero_Sale_for_Product_Report"); ?><img
                                            src="<?= $assets ?>images/new.gif" height="30px" alt="new" /></label>
                                    <div class="controls">
                                        <?php
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="order_discount"><?= lang("Sales Order Discount"); ?><img
                                            src="<?= $assets ?>images/new.gif" height="30px" alt="new" /></label>
                                    <div class="controls">
                                        <?php
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="order_discount"><?= lang("Reset Invoice Number"); ?><img
                                            src="<?= $assets ?>images/new.gif" height="30px" alt="new" /></label>
                                    <div class="controls">
                                        <?php
                                        $financial_year = [
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="sale_loose_products_with_variants"><?= lang("Loose Products Selling Options"); ?>
                                        <img src="<?= $assets ?>images/new.gif" height="25px" alt="new" /> </label>
                                    <div class="controls">
                                        <?php
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" for="product_weight"><?= lang("Products Weight"); ?>
                                        <img src="<?= $assets ?>images/new.gif" height="25px" alt="new" /> </label>
                                    <div class="controls">
                                        <?php
                                        $pw[0] = 'Disabled';
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" for="send_sales_excel"><?= lang("Send Sales Excel"); ?>
                                        <img src="<?= $assets ?>images/new.gif" height="25px" alt="new" /> </label>
                                    <div class="controls">
                                        <?php
                                        $sendexcel[0] = 'No';
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="synced_data_sales"><?= lang("Sales Synch Data"); ?> <img
                                            src="<?= $assets ?>images/new.gif" height="25px" alt="new" /> </label>
                                    <div class="controls">
                                        <?php
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="modify_qty_add_products"><?= lang("Modify Qty and add Product"); ?> <img
                                            src="<?= $assets ?>images/new.gif" height="25px" alt="new" /> </label>
                                    <div class="controls">
                                        <?php
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" for="deposit_discount"><?= lang("Deposit Discount"); ?>
                                        (%) <img src="<?= $assets ?>images/new.gif" height="25px" alt="new" /> </label>
                                    <div class="controls">
                                        <input type="text" value="<?= $Settings->deposit_discount?>"
                                            name="deposit_discount" class="form-control"
                                            placeholder="Deposit Discoutn in %" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="deposit_cash_limit"><?= lang("Deposit Cash Limit"); ?> (%) <img
                                            src="<?= $assets ?>images/new.gif" height="25px" alt="new" /> </label>
                                    <div class="controls">
                                        <input type="number" value="<?= $Settings->deposit_cash_limit?>" min="0"
                                            name="deposit_cash_limit" class="form-control"
                                            placeholder="Deposit Cash Limit" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="deposit_service_offer_manage"><?= lang("Deposit Service Offer Manage"); ?>
                                        (%) <img src="<?= $assets ?>images/new.gif" height="25px" alt="new" /> </label>
                                    <div class="controls">
                                        <?php
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="deposit_service_offer"><?= lang("Deposit Service Discount"); ?> (%) <img
                                            src="<?= $assets ?>images/new.gif" height="25px" alt="new" /> </label>
                                    <div class="controls">
                                        <input type="text" value="<?= $Settings->deposit_service_offer?>"
                                            name="deposit_service_offer" class="form-control"
                                            placeholder="Deposit Service Discount in %" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="payment_settlement_method"><?= lang("Bulk Payment settlement Method"); ?>
                                        *<img src="<?= $assets ?>images/new.gif" height="25px" alt="new" /> </label>
                                    <div class="controls">
                                        <?php
                        ...
                        <fieldset class="scheduler-border" id="prod-unit-setting">
                            <legend class="scheduler-border"><?= lang('Production Unit') ?></legend>

                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="production_order_age"><?= lang("Order Age"); ?><img
                                            src="<?= $assets ?>images/new.gif" height="30px" alt="new" /></label>
                                    <div class="controls">
                                        <?php
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="set_order_dispatch"><?= lang("Set_Order_Dispatch"); ?><img
                                            src="<?= $assets ?>images/new.gif" height="30px" alt="new" /></label>
                                    <div class="controls">
                                        <?php
                                        $opt = array(1 => lang('Yes'), 0 => lang('No'));
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" for="invoice_view_purchase"
                                        style="margin-top:16px;"><?= lang("invoice_view_purchase"); ?></label>
                                    <div class="controls">
                                        <?php
                                        $opt_inv = array(1 => lang('tax_invoice'), 0 => lang('standard'));
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label" for="tax_classification_view__purchase"
                                        style="margin-top:16px;"><?= lang("tax_classification_view__purchase"); ?></label>
                                    <div class="controls">
                                        <?php
                                        $opt_inv = array(1 => lang('Yes'), 0 => lang('No'));
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="purchase_discount"><?= lang("Purchase Order Discount"); ?><img
                                            src="<?= $assets ?>images/new.gif" height="30px" alt="new" /></label>
                                    <div class="controls">
                                        <?php
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="ppayment_prefix"><?= lang("ppayment_prefix"); ?></label>
                        ...
                        <fieldset class="scheduler-border" id="emailNsms">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label" for="sms_sender"><?= 'SMS Transactional Header'; ?>
                                        *</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="sms_promotional_header"><?= 'SMS Promotional Header'; ?> *</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label" for="reportsend"><?= 'Report Send On Email'; ?>
                                        *</label>

                                    <div class="controls">
                                        <select id="reportsend" class="form-control" name="reports_send_on_email">
                                            <option value="0"
                                                <?= ($Settings->reports_send_on_email == '0' ? 'Selected' : '') ?>>None
                                            </option>
                                            <option value="1"
                                                <?= ($Settings->reports_send_on_email == '1' ? 'Selected' : '') ?>>
                                                Monthly</option>
                        ...
                        <fieldset class="scheduler-border">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="control-label"
                                                    for="award_point_by_percent"><?= lang("Redeemption_Percent"); ?></label>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <?= lang('Synch Award Points With Consumer App', 'Synch Award Points'); ?> <img
                                            src="<?= $assets ?>images/new.gif" height="30px" alt="new" />
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <?= lang('Synch Customers With Consumer App', 'Synch Customers'); ?> <img
                                            src="<?= $assets ?>images/new.gif" height="30px" alt="new" />
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label"
                                        for="api_privatekey"><?= "API3 Access Private key"; ?></label>
                                    <?php
                                    ...
                                    <?php
                                            ...
                                            ?>
                                    <div id="apiprivatekey"><button class="btn btn-warning"
                                            id="generate_api_privatekey">Generate Private Key</button></div>
                                    <?php
                                        }//end else
                                        ?>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <span
                                        class="form-control"><?= $Settings->api_access ? 'Active' : 'Blocked' ?></span>
                                </div>
                            </div>
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <span
                                        class="form-control"><?= $Settings->active_eshop ? 'Active' : 'Deactive' ?></span>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label " for="active_webshop">Webshop / Ecommorce
                                        Module</label>
                                    <span
                                        class="form-control"><?= $Settings->active_webshop ? 'Active' : 'Deactive' ?></span>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label " for="active_urbanpiper">Urban Piper Delivery
                                        Platform</label>
                                    <span
                                        class="form-control"><?= $Settings->active_urbanpiper ? 'Active' : 'Deactive' ?></span>
                                </div>
                            </div>
                        </fieldset>
                        <?php } ?>
        ...
        <div class="alert alert-info" role="alert">
            <p>
                <strong>Cron Job:</strong>
                <code>0 1 * * * wget -qO- <?= site_url('cron/run'); ?> &gt;/dev/null 2&gt;&amp;1</code> to run at 1:00
                AM daily. For local installation, you can run cron job manually at any time.
                <?php if (!DEMO) { ?>
