        ...
        $.each(product.options, function(index, element) {
            ...
            if (element.name.toLowerCase() == 'note') {
                ...
                variantRow = '<tr>' +
                    ...
                    '<td class="w25-right"><input type="text" min="0" value="' + formatMoney() + '" class="form-control input-sm  subtotals width-setting" data-variant-id="' + element.id + '" id="subtotals"></td>' +
