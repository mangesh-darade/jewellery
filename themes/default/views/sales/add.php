                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php
                                                        ...
                                                        echo form_dropdown('billers', $bl, (isset($_POST['biller']) ? $_POST['biller'] : $pos_settings->default_biller), 'id="slbiller"  required="required" class="form-control input-tip select" style="width:100%;"');
                                                        ?>
                                </div>
                            </div>
                            <?php
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="hidden" name="quick_custome_nm" id="quick_custome_nm"
                                                        value="<?php echo (isset($_SESSION['quick_customerid']) ? $_SESSION['quick_customerid'] : ''); ?>">
                                                    ...
                                                    <div class="input-group-addon no-print" style="padding: 2px 8px;">
                                                        <a href="<?= site_url('customers/add/quick'); ?>"
    ...
    $.each(product.options, function(index, element) {
        ...
        if (element.name.toLowerCase() == 'note') {
            ...
            variantRow = '<tr>' +
                ...
                '<input type="text" min="0" value="' + formatMoney() + '" ' +
