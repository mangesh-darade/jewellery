...
//        }
 ...
 public function getProductOptionsByShapeId($id, $product_id)
    ...
    public function syncPurchaseItemsForProductionUnit($product_id, $location_id, $batchQuantity) {

        if (!empty($product_id)) {

            if ($purchase_items = $this->site->getPurchasedItems($product_id, $location_id)) {
