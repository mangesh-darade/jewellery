                ...
                if($this->input->post('form_action') == 'export_excel' || $this->input->post('form_action') == 'export_pdf') {
                    ...
                    foreach ($_POST['val'] as $id) {
                        ...
                        for ($i = 0; $i < $size; $i++) {
                            ...
                            $this->excel->getActiveSheet()->SetCellValue('F' . $excelRow, $product_name[$i]);
                            
                            // Quantity - middle align and formatQuantity as string
                            $this->excel->getActiveSheet()->SetCellValueExplicit('G' . $excelRow, $this->sma->formatQuantity($quantity[$i]), PHPExcel_Cell_DataType::TYPE_STRING);
                            $this->excel->getActiveSheet()->getStyle('G' . $excelRow)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
                        
                            // Unit Cost
                            $this->excel->getActiveSheet()->SetCellValue('H' . $excelRow, $this->sma->formatMoney($unit_cost[$i]));
                            $this->excel->getActiveSheet()->getStyle('H' . $excelRow)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
                        
                            // Tax
                            $this->excel->getActiveSheet()->SetCellValue('I' . $excelRow, $this->sma->formatMoney($tax[$i]));
                            $this->excel->getActiveSheet()->getStyle('I' . $excelRow)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
                        
                            // Subtotal
                            $this->excel->getActiveSheet()->SetCellValue('J' . $excelRow, $this->sma->formatMoney($subtotal[$i]));
                            $this->excel->getActiveSheet()->getStyle('J' . $excelRow)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
                        
                            // Total
                            $this->excel->getActiveSheet()->SetCellValue('K' . $excelRow, $this->sma->formatMoney($total[$i]));
                            $this->excel->getActiveSheet()->getStyle('K' . $excelRow)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
                        }
